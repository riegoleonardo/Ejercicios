...
public class CheapestDestination {
	...
	public CheapestDestination(HttpRequestService requestService, DestinationDeserializer flightDeserializer) {
	...
	public Destination getCheapestDestination(String from, String to) {
		...
		Destination cheapestFlight = destinationtDeserializer.getFlightToJason(json, CITY_COUNTRY.get(from), from, to);
